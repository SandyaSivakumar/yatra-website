      ...
      <footer className="relative z-10 bg-white pt-16 dark:bg-gray-dark md:pt-20 lg:pt-24">
        <div className="container">
          ...
          <div className="py-8">
            <p className="text-center text-base text-body-color dark:text-white">
              © {new Date().getFullYear()} Yatra Dance Productions. All rights reserved.
            </p>
          </div>
        </div>
        <div className="absolute right-0 top-14 z-[-1]">
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <circle opacity="0.8" cx="49.5" cy="49.5" r="49.5" fill="#FF0000" />
            <mask
              id="mask0_94:899"
          ...
          >
            ...
            <defs>
              ...
              >
                ...
                <stop offset="1" stopColor="#FF0000" stopOpacity="0.51" />
              </linearGradient>
              <linearGradient
